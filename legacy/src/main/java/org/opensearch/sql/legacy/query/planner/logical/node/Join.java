...
public class Join implements LogicalOperator {
   ...
   *
   * <p>For example, "ON (a.name = b.id AND a.age = b.age) OR a.location = b.address" => input list:
   * [ [ (a.name, b.id), (a.age, b.age) ], [ (a.location, b.address) ] ]
   *
   * <p>=> JoinCondition: leftTableAlias: "a", rightTableAlias: "b" leftColumnNames: [ ["name",
   * "age"], ["location"] ] rightColumnNames: [ ["id", "age"], ["address" ] ]
   */
