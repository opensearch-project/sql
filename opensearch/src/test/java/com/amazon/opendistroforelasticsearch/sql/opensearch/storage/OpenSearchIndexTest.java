...
import static com.amazon.opendistroforelasticsearch.sql.opensearch.utils.Utils.indexScan;
import static com.amazon.opendistroforelasticsearch.sql.opensearch.utils.Utils.indexScanAgg;
import static com.amazon.opendistroforelasticsearch.sql.opensearch.utils.Utils.noProjects;
import static com.amazon.opendistroforelasticsearch.sql.opensearch.utils.Utils.projects;
  ...
  void getFieldTypes() {
    ...
    assertThat(
        ...
        allOf(
            ...
            hasEntry("address", (ExprType) OpenSearchDataType.ES_TEXT),
            ...
            hasEntry("blob", (ExprType) OpenSearchDataType.ES_BINARY)
        ));
  }
