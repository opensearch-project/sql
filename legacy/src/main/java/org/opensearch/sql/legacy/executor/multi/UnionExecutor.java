...
public class UnionExecutor extends ElasticHitsExecutor {
  ...
  public void run() {
    ...
    fillInternalSearchHits(
        unionHits,
        secondResponse.getHits().getHits(),
  ...
  private void fillInternalSearchHits(
      List<SearchHit> unionHits, SearchHit[] hits, Map<String, String> fieldNameToAlias) {
  ...
  private void updateFieldNamesToAlias(
      Map<String, Object> sourceAsMap, Map<String, String> fieldNameToAlias) {
