...
/**
 * A simple resource-monitored iteration over the rows produced by a {@code rest} endpoint dispatch.
 * One-for-one parallel of {@code OpenSearchSystemIndexEnumerator}.
 */
public class RestEnumerator implements Enumerator<Object> {
  /** How many moveNext() calls to perform a resource check once. */
  private static final long NUMBER_OF_NEXT_CALL_TO_CHECK = 1000;

  private final List<String> fields;

  @EqualsAndHashCode.Include @ToString.Include private final RestRequest request;
  ...
  public RestEnumerator(List<String> fields, RestRequest request, ResourceMonitor monitor) {
    this.fields = fields;
