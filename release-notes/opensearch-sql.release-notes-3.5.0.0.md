...
* [Backport 3.5] Fix issue connecting with prometheus by wrapping with AccessController.doPrivilegedChecked ([#5101](https://github.com/opensearch-project/sql/pull/5101))
...
* [DOC] Add legacy ppl/index.rst for backwards compatibility ([#5026](https://github.com/opensearch-project/sql/pull/5026))
...
* [Backport 3.5][CVE-2026-24400] Upgrade assertj-core to 3.27.7 ([#5102](https://github.com/opensearch-project/sql/pull/5102))