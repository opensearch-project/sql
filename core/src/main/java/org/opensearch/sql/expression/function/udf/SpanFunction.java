  ...
  public static class SpanImplementor implements NotNullImplementor {
    ...
    public Expression implement(
      ...
      if (SqlTypeUtil.isNull(unitType)) {
        ...
        String methodName;
        if (OpenSearchTypeFactory.isDateExprType(fieldType)) {
          methodName = "evalDate";
        } else if (OpenSearchTypeFactory.isTimeExprType(fieldType)) {
          methodName = "evalTime";
        } else if (OpenSearchTypeFactory.isTimestampExprType(fieldType)) {
