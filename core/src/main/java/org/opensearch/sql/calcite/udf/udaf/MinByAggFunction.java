...
/**
 * MIN_BY aggregate function implementation. Returns the value from the first argument corresponding
 * to the minimum value of the second argument. Follows Spark SQL semantics: MIN_BY(value_field,
 * order_field)
 */
  ...
  public static class MinByAccumulator implements UserDefinedAggFunction.Accumulator {
    ...
    public void update(Object value, Object orderValue) {
      ...
      try {
        ...
        throw new IllegalArgumentException(
            "MIN_BY order field must be comparable. Got: " + orderValue.getClass().getSimpleName(),
            e);
      }
    }
  }
