...
/**
 * MAX_BY aggregate function implementation.
 * Returns the value from the first argument corresponding to the maximum value of the second argument.
 * Follows Spark SQL semantics: MAX_BY(value_field, order_field)
 */
    ...
    public void update(Object value, Object orderValue) {
      ...
      try {
        ...
        throw new IllegalArgumentException(
            "MAX_BY order field must be comparable. Got: " + orderValue.getClass().getSimpleName(), e);
      }
    }
  }
}
