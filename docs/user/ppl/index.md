...
| [makeresults command](cmd/makeresults.md) | 3.8 | experimental (since 3.8) | Yes | Generate in-memory rows for testing and seeding, optionally from inline CSV/JSON data. |
