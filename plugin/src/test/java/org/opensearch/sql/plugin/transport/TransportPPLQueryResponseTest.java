...
public class TransportPPLQueryResponseTest {
  ...
  @Test
  public void testFromActionResponseDifferentClassLoader() throws
      ...
      String classFilePath = loader.getResource("org/opensearch/sql/plugin/transport/TransportPPLQueryResponse.class").getPath();
      ...
      Class<?> class1 = classLoader1.findClass("org.opensearch.sql.plugin.transport.TransportPPLQueryResponse");
      Class<?> class2 = classLoader2.findClass("org.opensearch.sql.plugin.transport.TransportPPLQueryResponse");

      assertFalse(class1.isAssignableFrom(class2));
      String result = "mock result";
      TransportPPLQueryResponse response2 = TransportPPLQueryResponse.fromActionResponse((ActionResponse) class1.getDeclaredConstructor(String.class).newInstance(result));
