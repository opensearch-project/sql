...
public class NestedFieldProjection {
  ...
  /**
   * Why search for NestedQueryBuilder recursively? Because 1) it was added and wrapped by BoolQuery
   * when WHERE explained (far from here) 2) InnerHit must be added to the NestedQueryBuilder
   * related
   *
