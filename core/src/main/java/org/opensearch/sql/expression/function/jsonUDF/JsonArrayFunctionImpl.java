 ...
 * <p>Argument type:
 *
 * <p>A <value> can be any kind of value such as string, number, or boolean. Return type: ARRAY
 * (Spark ArrayType) It will also do implicit convert when we can find common types. E.g.
 * json_array(1, 2, 0, -1, 1.1, -0.11) = [1.0,2.0,0.0,-1.0,1.1,-0.11]
 */
