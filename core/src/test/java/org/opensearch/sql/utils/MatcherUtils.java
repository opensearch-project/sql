    ...
    return new TypeSafeDiagnosingMatcher<>() {
      ...
      protected boolean matchesSafely(ExprValue item, Description mismatchDescription) {
        ...
        if (Objects.isNull(expressionForKey)) {
          mismatchDescription
              .appendValue(item)
              .appendText(" does not contain key ")
              .appendValue(key);
          return false;
        }
        ...
        mismatchDescription
            .appendText(" value for key ")
            .appendValue(key)
            .appendText(" was ")
            .appendValue(givenValue);
        return false;
      }
      ...
      public void describeTo(Description description) {
        description
            .appendText("ExprValue should contain key ")
            .appendValue(key)
            .appendText(" with string value ")
            .appendValue(value);
      }
    };
  }
    ...
    return new TypeSafeDiagnosingMatcher<>() {
      ...
      protected boolean matchesSafely(ExprValue item, Description mismatchDescription) {
        ...
        mismatchDescription
            ...
            .appendValue(key)
            .appendText(" was ")
            .appendValue(expressionForKey.value());
        return false;
      }
