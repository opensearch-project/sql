...
| [outputlookup command](cmd/outputlookup.md) | 3.9 | experimental (since 3.9) | No | Write pipeline results into a lookup, read back with source=<name> or the lookup command. |
