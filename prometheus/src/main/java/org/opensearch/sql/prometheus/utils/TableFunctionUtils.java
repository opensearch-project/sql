...
public class TableFunctionUtils {
  ...
  /**
   * Validates if function arguments are valid
   * in both the cases when the arguments are passed by position or name.
   *
   ...
   */
  public static void validatePrometheusTableFunctionArguments(List<Expression> arguments,
  ...
  /**
   * Get Named Arguments of Table Function Arguments.
   * If they are passed by position create new ones or else return the same arguments passed.
   *
   * @param arguments arguments of function provided in the input order.
   * @param argumentNames ordered argument names of the function.
   */
  public static List<Expression> getNamedArgumentsOfTableFunction(List<Expression> arguments,
                                                                  List<String> argumentNames) {
    boolean argumentsPassedByPosition = arguments.stream()
        .allMatch(arg -> StringUtils.isEmpty(((NamedArgumentExpression) arg).getArgName()));
