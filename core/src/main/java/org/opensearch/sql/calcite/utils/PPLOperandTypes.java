...
public class PPLOperandTypes {
  ...
  // Standard Calcite SQL temporal types — UDT rewriting happens at prepare time via
  // TemporalUdtRewriteShuttle.
  public static final RelDataType DATE_T = TYPE_FACTORY.createSqlType(SqlTypeName.DATE);
  public static final RelDataType TIME_T = TYPE_FACTORY.createSqlType(SqlTypeName.TIME, 9);
  public static final RelDataType TIMESTAMP_T =
