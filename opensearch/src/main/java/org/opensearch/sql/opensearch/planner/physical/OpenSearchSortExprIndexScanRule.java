 ...
 */
@Value.Enclosing
public class OpenSearchSortExprIndexScanRule
    extends RelRule<OpenSearchSortExprIndexScanRule.Config> {

  protected OpenSearchSortExprIndexScanRule(Config config) {
    super(config);
  }
  ...
  public interface Config extends RelRule.Config {
    OpenSearchSortExprIndexScanRule.Config DEFAULT =
        ImmutableOpenSearchSortExprIndexScanRule.Config.builder()
            .build()
            .withOperandSupplier(
                b0 ->
    ...
    @Override
    default OpenSearchSortExprIndexScanRule toRule() {
      return new OpenSearchSortExprIndexScanRule(this);
    }
  }
}
