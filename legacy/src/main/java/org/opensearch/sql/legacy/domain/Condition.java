...
public class Condition extends Where {
  ...
  /**
   * Return true if the opear is {@link OPERATOR#NESTED_COMPLEX} For example, the opear is {@link
   * OPERATOR#NESTED_COMPLEX} when condition is nested('projects', projects.started_year > 2000 OR
