...
public class ResourceMonitorPlan extends PhysicalPlan implements ExternalizablePlan {
  ...
  @Override
  public ExternalizablePlan getPlanForSerialization() {
    return (ExternalizablePlan) delegate;
  }
