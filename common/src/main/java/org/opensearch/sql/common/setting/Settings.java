...
public abstract class Settings {
  ...
  public enum Key {
    ...
    CLUSTER_BUFFER_LIMIT("plugins.ppl.cluster.buffer.limit"),
    CLUSTER_MAX_CLUSTERS("plugins.ppl.cluster.max.clusters"),
    CLUSTER_MAX_INPUT_ROWS("plugins.ppl.cluster.max.input.rows"),
