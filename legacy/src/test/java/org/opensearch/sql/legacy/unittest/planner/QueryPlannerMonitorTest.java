...
import org.opensearch.sql.legacy.query.planner.resource.Stats.MemStats;
...
public class QueryPlannerMonitorTest extends QueryPlannerTest {
  ...
  public void reachedLimitAndRecoverAt3rdAttempt() {
    mockMemUsage(
        PERCENT_USAGE_15, PERCENT_USAGE_50, PERCENT_USAGE_50, PERCENT_USAGE_50, PERCENT_USAGE_15);
    queryWithLimit(25);
  }
    ...
    doAnswer(
            new Answer<MemStats>() {
              ...
              public MemStats answer(InvocationOnMock invocation) {
                ...
                return new MemStats(memUsages[callCnt][0], memUsages[callCnt][1]);
              }
            })
        .when(stats)
        .collectMemStats();
