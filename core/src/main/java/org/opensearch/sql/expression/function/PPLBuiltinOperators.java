...
public class PPLBuiltinOperators extends ReflectiveSqlOperatorTable {
  ...
  public static final SqlFunction ATAN =
      new SqlFunction(
        ...
        /**
         * Rewrite an ATAN call to use the appropriate operator based on argument count.
         *
         * <p>Sets the call's operator to `ATAN2` when the call has two operands, otherwise to `ATAN`.
         *
