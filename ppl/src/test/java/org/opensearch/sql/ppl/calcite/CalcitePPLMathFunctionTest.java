...
public class CalcitePPLMathFunctionTest extends CalcitePPLAbstractTest {
    ...
    public void testAbsWithOverriding() {
        ...
        String expectedLogical = "LogicalProject(SAL0=[ABS(-30)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
    ...
    public void testAcos() {
        ...
        String expectedLogical = "LogicalProject(ACOS=[ACOS(0)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testAsin() {
        ...
        String expectedLogical = "LogicalProject(ASIN=[ASIN(0)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testAtan() {
        ...
        String expectedLogical = "LogicalProject(ATAN=[ATAN2(2, 1:BIGINT)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testAtan2() {
        ...
        String expectedLogical = "LogicalProject(ATAN2=[ATAN2(2, 3)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testCbrt() {
        ...
        String expectedLogical = "LogicalProject(CBRT=[CBRT(27)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testCeiling() {
        ...
        String expectedLogical = "LogicalProject(CEILING=[CEIL(4.5E0:DOUBLE)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testConv() {
        ...
        String expectedLogical = "LogicalProject(CONV=[CONVERT(10, 10, 2)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testCos() {
        ...
        String expectedLogical = "LogicalProject(COS=[COS(0)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testCot() {
        ...
        String expectedLogical = "LogicalProject(COT=[COT(1)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testCrc32() {
        ...
        String expectedLogical = "LogicalProject(CRC32TEST=[CRC32('test')])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testDegrees() {
        ...
        String expectedLogical = "LogicalProject(DEGREES=[DEGREES(1.57E0:DOUBLE)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testEuler() {
        ...
        String expectedLogical = "LogicalProject(EULER=[E()])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testExp() {
        ...
        String expectedLogical = "LogicalProject(EXP=[EXP(2)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testFloor() {
        ...
        String expectedLogical = "LogicalProject(FLOOR1=[FLOOR(50.00005E0:DOUBLE)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testLn() {
        ...
        String expectedLogical = "LogicalProject(LN=[LN(2)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testLog() {
        ...
        String expectedLogical = "LogicalProject(LOG=[LOG(2, 2.718281828459045:DOUBLE)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testLog2() {
        ...
        String expectedLogical = "LogicalProject(LOG2=[LOG2(2)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testLog10() {
        ...
        String expectedLogical = "LogicalProject(LOG10=[LOG10(100)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testMod() {
        ...
        String expectedLogical = "LogicalProject(MOD=[MOD(10, 3)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testPowAndPower() {
        ...
        RelNode root = getRelNode(ppl);
        String expectedLogical = "LogicalProject(POW=[POWER(3, 2)], POWER=[POWER(2, 2)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testRadians() {
        ...
        RelNode root = getRelNode(ppl);
        String expectedLogical = "LogicalProject(RADIANS=[RADIANS(180)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testRand() {
        ...
        RelNode root = getRelNode(ppl);
        String expectedLogical = "LogicalProject(RAND=[RAND(1)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testRound() {
        ...
        RelNode root = getRelNode(ppl);
        String expectedLogical = "LogicalProject(ROUND=[ROUND(1.5E0:DOUBLE)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testSign() {
        ...
        RelNode root = getRelNode(ppl);
        String expectedLogical = "LogicalProject(SIGN=[SIGN(-1)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testSin() {
        ...
        String expectedLogical = "LogicalProject(SIN=[SIN(0)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
    ...
    public void testSqrt() {
        ...
        String expectedLogical = "LogicalProject(SQRT=[SQRT(4)])\n  LogicalTableScan(table=[[scott, EMP]])\n";
        verifyLogical(root, expectedLogical);
