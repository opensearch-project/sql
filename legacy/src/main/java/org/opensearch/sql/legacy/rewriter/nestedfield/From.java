...
class From extends SQLClause<SQLTableSource> {
  ...
  /**
   * Collect path alias and full path mapping of nested field in FROM clause. Sample: FROM team t,
   * t.employees e ...
   *
   * <p>Join / \ team t Join / \ t.employees e ...
   *
   * <p>t.employees is nested because path "t" == parentAlias "t" Save path alias to full path name
   * mapping {"e": "employees"} to Scope
   */
