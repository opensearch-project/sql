...
Example::
    ...
    os> source=people | eval array = array('apple', 'banana', 'apricot'), result = mvfind(array, 'ban.*') | fields result | head 1
    fetched rows / total rows = 1/1
    +--------+
    | result |
    |--------|
    ...
    os> source=people | eval array = array('cat', 'dog', 'bird'), result = mvfind(array, 'fish') | fields result | head 1
    fetched rows / total rows = 1/1
    +--------+
    | result |
    |--------|
    ...
    os> source=people | eval array = array('error123', 'info', 'error456'), result = mvfind(array, 'error[0-9]+') | fields result | head 1
    fetched rows / total rows = 1/1
    +--------+
    | result |
    |--------|
    ...
    os> source=people | eval array = array('Apple', 'Banana', 'Cherry'), result = mvfind(array, '(?i)banana') | fields result | head 1
    fetched rows / total rows = 1/1
    +--------+
    | result |
    |--------|
