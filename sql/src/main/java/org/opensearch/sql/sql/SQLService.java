...
import org.opensearch.sql.sql.parser.DataDefinitionTaskFactory;
...
public class SQLService {
  ...
  public UnresolvedPlan parse(String query) {
    ...
    QueryService queryService = new QueryService(
        analyzer, storageEngine, executionEngine, repository);
    DataDefinitionTaskFactory ddlFactory = new DataDefinitionTaskFactory(
        queryService, storageEngine);

    DataDefinitionPlan ast = ddlFactory.build(cst);
    if (ast != null) {
      return ast;
    }
