...
public class DateTimeParser {
  /**
   * Parse a string as MySQL would parse into a LocalDateTime - If it's purely numeric, interpret
   * based on length (YYYYMMDD, YYYYMMDDHHMMSS, etc.). - If it contains standard delimiters, try
   * date/time/datetime patterns. - If only date is found, time is set to 00:00:00. - If only time
   * is found, date is set to 1970-01-01.
   *
   ...
   *
   * <p>Length | Interpretation | Example -------|--------------------------|---------------- 4 |
   * YYMM | "0512" => ambiguous 6 | YYMMDD | "990101" => 1999-01-01 00:00:00 8 | YYYYMMDD |
   * "20230305" => 2023-03-05 00:00:00 12 | YYYYMMDDHHMM | "202303051210" => 2023-03-05 12:10:00 14
   * | YYYYMMDDHHMMSS | "20230305121030" => 2023-03-05 12:10:30
   *
   * <p>Return null if none match.
   */
  ...
  /**
   * Try a set of date/time/datetime patterns with delimiters/spaces. Return the first successful
   * parse or null otherwise.
   */
  private static LocalDateTime tryParseWithPatterns(String input) {
    ...
    DateTimeFormatter[] datePatterns = {DateTimeFormatter.ofPattern("yyyy-MM-dd")};
