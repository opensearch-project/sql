    ...
    assertEqual(
        ...
        filter(
            ...
            function(
                "query_string",
                unresolvedArg(
                    "query", stringLiteral("(NOT ((hello OR world)) AND (test OR demo))")),
                unresolvedArg("default_operator", stringLiteral("AND")))));
  }
        ...
        filter(
            ...
            function(
                ...
                unresolvedArg(
                    "query",
                    stringLiteral(
                        "((NOT (hello) AND NOT ((world OR test))) AND (demo AND NOT (example)))")),
                unresolvedArg("default_operator", stringLiteral("AND")))));
  }
        ...
        filter(
            ...
            function(
                ...
                unresolvedArg(
                    "query",
                    stringLiteral(
                        "(((hello OR world) AND (test OR demo)) OR NOT ((foo AND bar)))")),
                unresolvedArg("default_operator", stringLiteral("AND")))));
  }
            ...
            and(
                and(
                    function(
                        "query_string",
                        unresolvedArg(
                            "query", stringLiteral("((error OR warning) AND NOT (debug))")),
                        unresolvedArg("default_operator", stringLiteral("AND"))),
