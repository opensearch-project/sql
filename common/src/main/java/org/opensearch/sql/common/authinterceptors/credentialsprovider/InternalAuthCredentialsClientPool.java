...
/**
 * This class fetches credentials provider from different sources(based on priority)
 * and uses the first one that works.
 */
public final class InternalAuthCredentialsClientPool {

  private static final InternalAuthCredentialsClientPool instance =
      new InternalAuthCredentialsClientPool();
  ...
  /**
  * Get InternalAuthCredentialsClient.
  */
