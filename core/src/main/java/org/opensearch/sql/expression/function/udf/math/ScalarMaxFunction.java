...
public class ScalarMaxFunction extends ImplementorUDF {
  ...
  /**
   * Provide operand metadata indicating the function accepts a variadic number of arguments.
   *
   * @return a {@link UDFOperandMetadata} configured for variadic operands
   */
  @Override
