...
/**
 * This class builds aggregation query for the given stats commands. In the generated query a
 * placeholder(%s) is added in place of metric selection query and later replaced by metric
 * selection query.
 */
@NoArgsConstructor
public class AggregationQueryBuilder {

  private static final Set<String> allowedStatsFunctions =
      Set.of(
