...
/**
 * Test cases to reproduce and validate the aligntime issue with bin command.
 * The issue: aligntime="@d+4h" should produce timestamps like "2025-07-27 16:00" and "2025-07-28 04:00"
 * but we're getting wrong timestamps due to incorrect alignment point calculation.
 */
public class BinSpanFunctionTest {
  ...
  public void testAlignTimeAtDPlus4HoursProblem() {
    ...
    System.out.println("\n=== Debug Analysis ===");
    System.out.println("Issue: The alignment calculation should produce bins starting at 16:00 for the 18:30 input");
    ...
    long nextDayTimestamp = testTimestamp + 86400000L + (8 * 3600000L); // Next day + 8 hours = 02:30 next day
    ...
    System.out.println("Expected: 2025-07-28 04:00:00 (since 02:30 is before 04:00, it should go to previous bin)");
    ...
    System.out.println("Next day relative position: " + nextDayRelativePos + "ms (NEGATIVE - this is the problem!)");
    
    System.out.println("\n=== ROOT CAUSE IDENTIFIED ===");
    System.out.println("Problem: When timestamp is before the alignment point in the day,");
    System.out.println("relative position becomes negative, causing floor() to give wrong bin number.");
    System.out.println("Solution: Need to handle negative relative positions correctly in the binning logic.");
  }
  ...
  public void testCorrectAlignmentLogic() {
    ...
    assertTrue(nextDayBinNumber < 0, "Bin number should be negative for timestamps before alignment point");
  ...
  public void testIdentifyExactIssueInCode() {
    ...
    System.out.println("");
    System.out.println("// Perform binning: floor(relativePosition / intervalMillis) * intervalMillis");
    ...
    System.out.println("RexNode binNumber = context.relBuilder.call(SqlStdOperatorTable.FLOOR, divided);");
    System.out.println("```");
    System.out.println("");
    System.out.println("ISSUE: When relativePosition is negative (timestamp before alignment point),");
    ...
    System.out.println("");
    System.out.println("SOLUTION: Replace the simple FLOOR division with proper negative handling:");
    System.out.println("- For positive relativePosition: use FLOOR(relativePosition / interval)");  
    System.out.println("- For negative relativePosition: use FLOOR((relativePosition - interval + 1) / interval)");
