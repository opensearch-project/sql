...
/**
 * DynamicPivotExecutor is responsible for executing the two-phase approach for the timechart command.
...
public class DynamicPivotExecutor {
    ...
    public static void execute(
        ...
        executionEngine.execute(distinctQuery, new ResponseListener<QueryResponse>() {
            @Override
    ...
    /**
     * Explain the pivot operation in two phases:
     * 1. Execute a query to get distinct values for the "by" field
     * 2. Use those distinct values to build the pivot table
     *
     * @param executionEngine The execution engine to use for executing the queries
    ...
    public static void explain(
        ...
        executionEngine.explain(distinctQuery, new ResponseListener<ExplainResponse>() {
            @Override
        ...
        executionEngine.explain(pivotQuery, new ResponseListener<ExplainResponse>() {
            @Override
            public void onResponse(ExplainResponse response) {
