...
class QueryTest {
  ...
  public void test_SyntaxCheckException_when_no_arguments() {
    ...
    assertThrows(
        SyntaxCheckException.class, () -> queryQuery.build(new QueryExpression(arguments)));
  }

  @Test
  public void test_SyntaxCheckException_when_field_argument() {
    List<Expression> arguments =
        List.of(namedArgument("fields", "invalid argument"), namedArgument("query", query_value));
    assertThrows(
        SemanticCheckException.class, () -> queryQuery.build(new QueryExpression(arguments)));
  }
  ...
  public void test_SemanticCheckException_when_invalid_parameter() {
    List<Expression> arguments =
        List.of(
            namedArgument("query", query_value), namedArgument("unsupported", "unsupported_value"));
  ...
  public void test_can_get_query_name() {
    ...
    Assertions.assertEquals("query", queryQuery.getQueryName());
  }
}
