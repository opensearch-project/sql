...
public class ConvertTZFunctionIT extends SQLIntegTestCase {
  ...
  public void inRangeZeroToPositive() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2008-05-15 12:00:00','+00:00','+10:00')", null, "datetime"));
  ...
  public void inRangeNegativeZeroToPositiveZero() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-12 00:00:00','-00:00','+00:00')", null, "datetime"));
  ...
  public void inRangePositiveToPositive() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-12 00:00:00','+10:00','+11:00')", null, "datetime"));
  ...
  public void inRangeNegativeToPositive() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-12 11:34:50','-08:00','+09:00')", null, "datetime"));
  ...
  public void inRangeSameTimeZone() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-12 11:34:50','+09:00','+09:00')", null, "datetime"));
  ...
  public void inRangeTwentyFourHourTimeOffset() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-12 11:34:50','-12:00','+12:00')", null, "datetime"));
  ...
  public void inRangeFifteenMinuteTimeZones() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-12 13:00:00','+09:30','+05:45')", null, "datetime"));
  ...
  public void inRangeRandomTimes() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-12 13:00:00','+09:31','+05:11')", null, "datetime"));
  ...
  public void nullField2Under() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-30 11:34:50','-14:00','+08:00')", null, "datetime"));
  ...
  public void nullField3Over() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-12 11:34:50','-12:00','+14:01')", null, "datetime"));
    verifyDataRows(result, rows(new Object[] {null}));
  }
  ...
  public void inRangeMinOnPoint() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-12 15:00:00','-13:59','-13:59')", null, "datetime"));
  ...
  public void nullField3InvalidInput() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-12 11:34:50','+10:0','+14:01')", null, "datetime"));
    verifyDataRows(result, rows(new Object[] {null}));
  }
  ...
  public void nullField2InvalidInput() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-05-12 11:34:50','+14:01','****')", null, "datetime"));
    verifyDataRows(result, rows(new Object[] {null}));
  }
  ...
  public void nullDateTimeInvalidInput() throws IOException {
    ...
    verifySchema(result, schema("convert_tz('2021----','+00:00','+00:00')", null, "datetime"));
    verifyDataRows(result, rows(new Object[] {null}));
  }
  ...
  public void nullDateTimeInvalidDateValueFebruary() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-02-30 10:00:00','+00:00','+00:00')", null, "datetime"));
    verifyDataRows(result, rows(new Object[] {null}));
  }
  ...
  public void nullDateTimeInvalidDateValueApril() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-04-31 10:00:00','+00:00','+00:00')", null, "datetime"));
    verifyDataRows(result, rows(new Object[] {null}));
  }
  ...
  public void nullDateTimeInvalidDateValueMonth() throws IOException {
    ...
    verifySchema(
        result, schema("convert_tz('2021-13-03 10:00:00','+00:00','+00:00')", null, "datetime"));
    verifyDataRows(result, rows(new Object[] {null}));
  }
}
