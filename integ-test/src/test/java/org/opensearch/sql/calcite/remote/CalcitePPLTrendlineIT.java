...
public class CalcitePPLTrendlineIT extends PPLIntegTestCase {
  ...
  public void testTrendlineSma() throws IOException {
    JSONObject result =
        executeQuery(
            Index.BANK.ppl(
                "where balance > 30000 | trendline sma(3, balance) as balance_trend |"
  ...
  public void testTrendlineWma() throws IOException {
    JSONObject result =
        executeQuery(
            Index.BANK.ppl(
                "where balance > 30000 | trendline wma(3, balance) as balance_trend |"
                    + " fields balance_trend"));
    verifySchema(result, schema("balance_trend", "double"));
    verifyDataRows(
  ...
  public void testTrendlineMultipleFields() throws Exception {
    JSONObject result =
        executeQuery(
            Index.BANK.ppl(
                "where balance > 30000 | trendline sma(2, balance) as sma wma(3,"
  ...
  public void testTrendlineNoAlias() throws Exception {
    JSONObject result =
        executeQuery(
            Index.BANK.ppl(
                "where balance > 30000 | trendline sma(2, balance) | fields"
  ...
  public void testTrendlineOverwritesExisingField() throws Exception {
    JSONObject result =
        executeQuery(
            Index.BANK.ppl(
                "where balance > 30000 | trendline sma(2, balance) as balance | fields"
                    + " balance"));
  ...
  public void testTrendlineWithSort() throws Exception {
    JSONObject result =
        executeQuery(
            Index.BANK.ppl(
                "where balance > 30000 | trendline sort - balance sma(2, balance) |"
