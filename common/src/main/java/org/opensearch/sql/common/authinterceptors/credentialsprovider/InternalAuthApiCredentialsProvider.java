...
class InternalAuthApiCredentialsProvider implements AWSCredentialsProvider {
  ...
  InternalAuthApiCredentialsProvider(InternalAuthCredentialsClient internalApiCredentialsClient,
                                     String policyType) {
  ...
  public synchronized void refresh() {
    ...
    InternalAwsCredentials apiCredentials =
        internalApiCredentialsClient.getAwsCredentials(policyType);
    ...
    if (apiCredentials == null) {
      ...
      this.expiryTimestamp = apiCredentials.getExpiry() - 10000;
    }
  }
