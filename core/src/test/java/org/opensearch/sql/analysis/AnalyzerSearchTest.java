...
public class AnalyzerSearchTest {
  ...
  public void setUp() {
    ...
    when(mockTable.getFieldTypes()).thenReturn(ImmutableMap.of(
  ...
  public void testVisitSearchWithSimpleQuery() {
    ...
    org.opensearch.sql.datasource.model.DataSource mockDataSource = mock(org.opensearch.sql.datasource.model.DataSource.class);
    org.opensearch.sql.storage.StorageEngine mockStorageEngine = mock(org.opensearch.sql.storage.StorageEngine.class);
    ...
    when(expressionAnalyzer.analyze(any(Function.class), eq(context)))
        .thenReturn(queryStringExpr);
