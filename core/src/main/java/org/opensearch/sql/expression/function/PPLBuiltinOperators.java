...
public class PPLBuiltinOperators extends ReflectiveSqlOperatorTable {
  ...
  public static final SqlOperator MINUTE_OF_DAY =
      UserDefinedFunctionUtils.adaptExprMethodToUDF(
              ...
              "exprMinuteOfDay",
              UserDefinedFunctionUtils.INTEGER_FORCE_NULLABLE,
              NullPolicy.ARG0)
          .toUDF("MINUTE_OF_DAY");
  ...
  public static final SqlOperator CONVERT_TZ =
      UserDefinedFunctionUtils.adaptExprMethodToUDF(
              DateTimeFunctions.class,
              "exprConvertTZ",
              UserDefinedFunctionUtils.TIMESTAMP_INFERENCE,
              NullPolicy.ANY)
          .toUDF("CONVERT_TZ");
  ...
  public static final SqlOperator FROM_DAYS =
      UserDefinedFunctionUtils.adaptExprMethodToUDF(
              DateTimeFunctions.class,
              "exprFromDays",
              UserDefinedFunctionUtils.DATE_INFERENCE,
              NullPolicy.ANY)
          .toUDF("FROM_DAYS");
  ...
  public static final SqlOperator MAKETIME =
      UserDefinedFunctionUtils.adaptExprMethodToUDF(
              DateTimeFunctions.class,
              "exprMakeTime",
              UserDefinedFunctionUtils.TIME_INFERENCE,
              NullPolicy.ANY)
          .toUDF("MAKETIME");
