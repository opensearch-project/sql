...
class OpenSearchExprTextValueTest {
  ...
  void non_text_types_arent_converted() {
    assertAll(
        () ->
            assertEquals(
                "field",
                OpenSearchTextType.convertTextToKeyword("field", OpenSearchDataType.of(INTEGER))),
        () ->
            assertEquals(
                "field",
                OpenSearchTextType.convertTextToKeyword("field", OpenSearchDataType.of(STRING))),
        () ->
            assertEquals(
                "field",
  ...
  void non_text_types_with_nested_objects_arent_converted() {
    ...
    var arrayType =
        OpenSearchDataType.of(
            OpenSearchDataType.MappingType.Nested,
            Map.of("subfield", OpenSearchDataType.of(STRING)));
    assertAll(
