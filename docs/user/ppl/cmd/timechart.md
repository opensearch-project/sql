...
* `aggregation_function`: mandatory. The aggregation function to apply to each time bucket.  
  ...
  * Available functions: All aggregation functions supported by the [stats](stats.md) command, as well as the timechart-specific aggregations listed in the following section.  
