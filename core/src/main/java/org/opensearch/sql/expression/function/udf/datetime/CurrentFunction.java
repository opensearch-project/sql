...
public class CurrentFunction extends ImplementorUDF {
  ...
  public SqlReturnTypeInference getReturnTypeInference() {
    return opBinding ->
        switch (kind) {
          case DATE -> UserDefinedFunctionUtils.NULLABLE_DATE_T;
          case TIME -> UserDefinedFunctionUtils.NULLABLE_TIME_T;
          case TIMESTAMP -> UserDefinedFunctionUtils.NULLABLE_TIMESTAMP_T;
        };
  }
