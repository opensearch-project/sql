...
public class PPLQueryDataAnonymizerTest {
  ...
  @Test
  public void testNativeQueryCommand() {
    assertEquals("source=prometheus.nativeQuery(`http_request_param`,starttime=123,endtime=455)",
        anonymize("source=prometheus.nativeQuery(`http_request_param`,starttime=123,endtime=455 )")
    );
  }
