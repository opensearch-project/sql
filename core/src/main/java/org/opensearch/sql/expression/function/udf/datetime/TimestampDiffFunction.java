...
public class TimestampDiffFunction extends ImplementorUDF {
  ...
  public static class DiffImplementor implements NotNullImplementor {
    ...
    public Expression implement(
      ...
      boolean startIsTime =
          startRelType instanceof ExprTimeType || startRelType.getSqlTypeName() == SqlTypeName.TIME;
      boolean endIsTime =
          endRelType instanceof ExprTimeType || endRelType.getSqlTypeName() == SqlTypeName.TIME;
