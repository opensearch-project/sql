...
public class JsonKeysFunctionImpl extends ImplementorUDF {
  ...
  /**
   * Specifies the operand metadata for this UDF as accepting any SQL type for all operands.
   *
   * @return a {@link UDFOperandMetadata} that wraps {@link org.apache.calcite.sql.type.OperandTypes#ANY}
   */
  @Override
  public UDFOperandMetadata getOperandMetadata() {
    return UDFOperandMetadata.wrap(OperandTypes.ANY);
  }
