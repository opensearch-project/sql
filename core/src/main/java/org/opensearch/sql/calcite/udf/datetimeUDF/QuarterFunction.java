...
import static org.opensearch.sql.expression.datetime.DateTimeFunctions.exprQuarter;
...
public class QuarterFunction implements UserDefinedFunction {
  @Override
  ...
  public ExprValue extractForTime(ExprValue candidate, FunctionProperties functionProperties) {
    return exprQuarter(transferTimeToTimestamp(candidate, functionProperties));
  }

  public ExprValue extract(ExprValue candidate) {
    return exprQuarter(candidate);
  }
}
