...
public class UTCDateImpl extends ImplementorUDF {
    public UTCDateImpl() {
        super(new UTCDateImplementor(), NullPolicy.ANY);
    }
    ...
    public static class UTCDateImplementor implements NotNullImplementor {
        @Override
        public Expression implement(RexToLixTranslator rexToLixTranslator, RexCall rexCall, List<Expression> list) {
            ...
            return Expressions.call( Types.lookupMethod(
                    UTCDateImpl.class, "eval", Object[].class),  newList);
        }
    }
    ...
    public static Object eval(Object... args) {
        ...
        return exprUtcDate(restored).valueForCalcite();
    }
}
