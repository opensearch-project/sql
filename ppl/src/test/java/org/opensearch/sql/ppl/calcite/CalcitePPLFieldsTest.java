...
/**
 * Test suite for PPL fields command functionality with Calcite engine.
 * Tests both comma-delimited and space-delimited field selection syntax.
 */
public class CalcitePPLFieldsTest extends CalcitePPLAbstractTest {
  ...
  /**
   * Tests space-delimited fields in complex pipeline operations.
   * Note: Calcite optimizes sort and limit into single LogicalSort with fetch parameter.
   */
  @Test
  public void testFieldsSpaceDelimitedComplexPipeline() {
    String ppl = "source=EMP | where DEPTNO in (10, 20) | sort - SAL | fields EMPNO ENAME DEPTNO SAL | head 5";
    RelNode root = getRelNode(ppl);
