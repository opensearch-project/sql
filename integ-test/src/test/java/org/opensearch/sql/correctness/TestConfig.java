...
/**
 * Test configuration parse the following information from command line arguments: 1) Test schema
 * and data 2) Test queries 3) OpenSearch connection URL 4) Other database connection URLs
 */
