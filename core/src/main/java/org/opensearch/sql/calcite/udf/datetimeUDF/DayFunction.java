...
import static org.opensearch.sql.expression.datetime.DateTimeFunctions.exprDayOfMonth;
...
public class DayFunction implements UserDefinedFunction {
  ...
  public ExprValue extractForTime(ExprValue candidate, FunctionProperties functionProperties) {
    return exprDayOfMonth(transferTimeToTimestamp(candidate, functionProperties));
  }

  public ExprValue extract(ExprValue candidate) {
    return exprDayOfMonth(candidate);
  }
}
